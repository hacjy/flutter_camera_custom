...
class CameraController extends ValueNotifier<CameraValue> {
  ...
  Future<void> initialize() async {
    ...
    try {
      ...
      addCameraClosingListen();
      addCameraErrorListen();
  ...
  Future<void> addCameraClosingListen() async {
    try {
      await CameraPlatform.instance.onCameraClosing(_cameraId).listen((event) {
        print('cameraClosingListen');
        _isDisposed = true;
      });
    } catch (e) {
      print(e);
  ...
  Future<void> addCameraErrorListen() async {
    try {
      await CameraPlatform.instance.onCameraError(_cameraId).listen((event) {
        print('cameraErrorListen = ${event.description}');
        _isDisposed = true;
      });
    } catch (e) {
      print(e);
  ...
  Future<void> dispose() async {
    print('dispose _isDisposed=${_isDisposed}');
    if (_isDisposed) {
      return;
    }
